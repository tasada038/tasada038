#!/usr/bin/python
# https://sd08419ttic.hatenablog.com/entry/2021/07/25/171617
import rclpy
...
class Ms5837Node(Node):
    ...
    def __init__(self):
        ...
        self.pub_pressure = self.create_publisher(FluidPressure, 'bar30/pressure', 10)
        self.pub_temp = self.create_publisher(Temperature, 'bar30/temperature', 10)
        self.pub_depth = self.create_publisher(Float64, 'bar30/depth', 10)
    ...
    def timer_callback(self):
        ...
        self.get_logger().info('Pressure : {} hpa'.format(self.msg_pressure.fluid_pressure))
        self.get_logger().info('Temperature :{} C'.format(self.msg_temp.temperature))
